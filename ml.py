...
def training_test(author1_author1, author1_author2):
    data_x = author1_author1 + author1_author2
    data_y = [0 for _ in range(len(author1_author1))] + [1 for _ in range(len(author1_author2))]
...
def training(author1_author1, author1_author2, x_test):
    x_train = author1_author1 + author1_author2
    y_train = [0 for _ in range(len(author1_author1))] + [1 for _ in range(len(author1_author2))]
...
def wholesale_parameters_measurer(author1_author1, author1_author2):
    ...
    conf_matrix = []
    for i in range(100):
        accuracy.append(training_test(author1_author1, author1_author2)[0])
        precision.append(training_test(author1_author1, author1_author2)[1])
        recall.append(training_test(author1_author1, author1_author2)[2])
        conf_matrix.append(training_test(author1_author1, author1_author2)[3])
